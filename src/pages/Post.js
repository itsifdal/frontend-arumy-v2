        ...
        <Stack direction="row" mb={2}>
          <FormControl sx={styleform}>
            ...
            <TextField
              ...
              sx={{ width: 150, mr: 1 }}
            />
            <Button variant="contained" size="small" sx={{ ml: 1, mt: 1 }} type="submit" onClick={SubmitFilter}>
              Filter{" "}
            </Button>
            <Button variant="contained" size="small" sx={{ ml: 1, mt: 1 }} type="submit" onClick={ResetFilter}>
              Reset{" "}
            </Button>
          </FormControl>
        </Stack>
