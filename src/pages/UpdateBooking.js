...
export default function Booking() {
  ...
  const handleSubmitUpdate = (e) => {
    e.preventDefault();
    const data = {
      roomId, teacherId, instrumentId, tgl_kelas : formattedDate, cabang, jam_booking : tmstr, jenis_kelas, durasi, status : 'pending'
    }
        ...
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          <FormControl fullWidth >
            ...
            <TextField
              ...
              select
              margin="normal" label="Ruang" value={roomId} onChange={handleChangeRuang}
            >
            ...
            <TextField
              ...
              select
              margin="normal" label="Teacher" value={teacherId} onChange={handleChangeTeacher}
            >
            ...
            <TextField
              ...
              select
              margin="normal" label="Instrument" value={instrumentId} onChange={handleChangeInstrument}
            >
            ...
            <TextField 
              required 
              id="outlined-required" margin="normal" label="Cabang" name="cabang"
              value={cabang}
              onChange={(e) => {
            ...
            <LocalizationProvider dateAdapter={AdapterDateFns}>
              <TimePicker 
                label="Jam Booking" ampm={false} format="HH:mm:ss" margin="normal" value={tm_start}
                onChange={(newValue) => {
                  setTmStart(newValue)
                }}
                renderInput={(props) => (
            ...
            <TextField
              ...
              select
              margin="normal" label="Jenis Kelas" value={jenis_kelas} onChange={handleChangeJenis}
            >
            ...
            <TextField 
              required 
              id="outlined-required" margin="normal" label="Durasi" name="durasi"
              value={durasi}
              onChange={(e) => {
                setDurasi(e.target.value)
              }} 
            />
            <Button variant="contained" type="submit" onClick={handleSubmitUpdate}>Submit</Button>
          </FormControl>
        </Stack>
      </Container>
    </Page>
