...
import { useDeleteTeacher } from "./query";

export function TeacherDeleteModal({ open, onClose, dataName, id, onSuccess, onError }) {
  const submitDeletePacket = useDeleteTeacher({ id });
