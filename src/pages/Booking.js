...
export default function Booking() {
  ...
  const SubmitUpdateData = (e) => {
    e.preventDefault();
    const data = {
      durasi, roomId, kategori : jenisKelas, booking_date : dt, time_start : tmstr, time_end : tmend
    }
  ...
  if (user && user.role === 'Admin') {
    button = <Button variant="contained"  startIcon={<Iconify icon="eva:plus-fill"/>} onClick={MoveToAddBookingPage}>
              New Booking
            </Button>
  }
